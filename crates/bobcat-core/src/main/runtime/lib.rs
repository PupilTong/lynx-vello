...
impl MainThreadRuntime {
    ...
    pub(crate) fn run_main_thread_script(
        ...
        let boot = format!(
            r#"import {{ lynx, __BobcatConnectBackground, __BobcatInitializeMTS, __BobcatPageLoaded, __BobcatProcessInitData, __BobcatRenderPage, __BobcatBackgroundData, __BobcatInitEntry }} from "{RUNTIME_MODULE_SPECIFIER}";
