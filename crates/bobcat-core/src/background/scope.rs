...
use crate::esm::{
    ...
    GLOBAL_EVENT_MODULE_SOURCE, GLOBAL_EVENT_MODULE_SPECIFIER, REQUIRE_MODULE_SOURCE,
...
/// runtime shares.
///
/// The worker runtime carries its global scope, timers, `require`, shared
/// event machinery and the BTS runtime module. Each script chooses its own
/// imports.
