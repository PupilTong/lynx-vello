...
use crate::web::style_info::StyleInfo;
use crate::web::{MAGIC_0, MAGIC_1, SectionLabel, WebTemplate};
...
fn encode_style_info(style_info: &StyleInfo) -> Result<Vec<u8>, ConvertError> {
