...
- `crates/bobcat-core` — unified native runtime core. Its public runtime is the
  ...
  drops pending resource work or interrupts active startup JavaScript, then
  stops and joins both engine-owned threads. The default family is prepended
  to the `system-ui`, `sans-serif`,
