...
BTS worker and runs the optional background body as a JavaScript module.
Omitting that body leaves the worker running only the built-in BTS runtime;
a present empty body is still a registered module.
