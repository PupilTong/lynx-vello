...
ReactLynx app, rendered **in a browser** through [`@lynx-js/web-core`](https://www.npmjs.com/package/@lynx-js/web-core),
...
- `rsbuild.lynx.config.ts` builds the app for the `web` environment, loading ReactLynx
